...
- You can subscribe to an [announcement listserv](https://lists.getincognito.org) to get critical announcements from the Incognito core team. The announcement list can be very helpful for knowing when software updates are needed.
...
* Change to the root of the source code directory, change to the most recent release branch, and build:
    ...
    *Note*: The instructions above will compile the most stable release of the
    Incognito software. If you would like to use and test the most recent software,
...
While Incognito isn't made to integrate with Tor, it can be used wrapped with torsocks, by
...
Configure Incognito with the -D SANITIZE=ON cmake flag, eg:
